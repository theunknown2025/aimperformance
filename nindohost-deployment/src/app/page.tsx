  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link 
                ...
                className={`font-semibold px-6 py-2 rounded-lg transition-colors duration-200 ${
                  isScrolled 
                    ? 'text-gray-700 hover:text-[#51b960] border border-gray-300 hover:border-[#51b960]' 
                    : 'text-white hover:text-[#51b960] border border-white/30 hover:border-[#51b960]'
                }`}
              >
                Se connecter
              </Link>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-4 py-4 space-y-4">
                ...
                <Link 
                  href="/login"
                  className="w-full text-gray-700 hover:text-[#51b960] font-medium py-3 px-4 rounded-lg border border-gray-300 hover:border-[#51b960] transition-colors duration-200 text-center block"
                >
                  Se connecter
                </Link>
                <button 
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <div className="bg-white rounded-2xl p-8 border border-white/20 w-4/5 mx-auto">
          ...
          >
            <div className="flex flex-wrap justify-center items-center gap-4 text-white/90 mb-6">
              <div className="flex items-center gap-2">
                <FaMapMarkerAlt />
                <span>Casablanca • Tanger • Fes</span>
              </div>
              <div className="flex items-center gap-2">
                <FaCalendarAlt />
      ...
      <section 
        ...
        style={{
          backgroundImage: 'url(/uploads/image/back.png)',
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat',
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full">
            {[
              {
                id: 1,
                name: "Fatimzahra Mziouad Bennis",
                title: "CEO",
                company: "Aimperformance",
                linkedin: "#"
              },
              {
                id: 2,
              ...
              >
                {/* Speaker Card */}
                <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl p-8 border border-white/40 shadow-2xl">
                  <div className="flex items-center gap-8">
                    {/* Speaker Image */}
                    <div className="flex-shrink-0">
                      <div className="w-48 h-48 rounded-full overflow-hidden border-4 border-[#51b960] shadow-lg">
                        <img 
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#51b960] text-lg mb-2 font-semibold">
                        {speaker.title}
                      </p>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <FaBuilding className="text-[#51b960] mt-1" />
                    <div>
                      <p className="font-semibold text-gray-900">AIM</p>
                      <p className="text-gray-600">Accompagnement, Innovation et Management</p>
                      <p className="text-gray-600">Angle Bd Zerktouni et Rue Goulmima, Imm Jassim 2, 2ème étage, N°4 Casablanca</p>
                    </div>
                  </div>

                  <div className="flex items-center gap-4">
                    <FaGlobe className="text-[#51b960]" />
                    <a href="https://www.aimperformance.ma/" className="text-gray-600 hover:text-[#51b960] underline" target="_blank" rel="noopener noreferrer">
                      https://www.aimperformance.ma/
                    </a>
                  </div>

                  <div className="flex items-center gap-4">
                    <FaPhone className="text-[#51b960]" />
                    <span className="text-gray-600">06 63 68 80 26 / 06 64 00 75 25</span>
                  </div>

                  <div className="flex items-center gap-4">
                    <FaEnvelope className="text-[#51b960]" />
                    <a href="mailto:contact@aimperformance.ma" className="text-gray-600 hover:text-[#51b960] underline">
                      contact@aimperformance.ma
                    </a>
                  </div>
      ...
      <footer className="bg-[#333230] text-white py-16">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Nous nous sommes engagés à accompagner les entreprises nationales et étrangères de différentes activités souhaitant confier à un partenaire professionnel et expérimenté la transformation de leurs capacités et la formation de leurs ressources humaines à travers un accompagnement sur mesure où le savoir, le savoir-faire et le savoir être sont combinés afin de vous apporter des solutions de conseil et de formation adaptées à vos enjeux et vos objectifs stratégiques & opérationnels.
              </p>
              <div className="space-y-2 text-gray-300">
                <p>Angle Bd Zerktouni et Rue Goulmima, Imm Jassim 2, 2ème étage, N°4 Casablanca</p>
                <p>06 63 68 80 26 / 06 64 00 75 25</p>
                <p>contact@aimperformance.ma</p>
                <p>www.aimperformance.ma</p>
              </div>
            </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-gray-400">© 2025 AIM. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
